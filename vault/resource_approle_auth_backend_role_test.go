		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("vault_approle_auth_backend_role.role",
						"bound_cidr_list.#", "2"),
					resource.TestCheckResourceAttr("vault_approle_auth_backend_role.role",
						"bound_cidr_list.0", "10.148.0.0/20"),
					resource.TestCheckResourceAttr("vault_approle_auth_backend_role.role",
						"bound_cidr_list.1", "10.150.0.0/20"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("vault_approle_auth_backend_role.role",
						"bound_cidr_list.#", "2"),
					resource.TestCheckResourceAttr("vault_approle_auth_backend_role.role",
						"bound_cidr_list.0", "10.150.0.0/20"),
					resource.TestCheckResourceAttr("vault_approle_auth_backend_role.role",
						"bound_cidr_list.1", "10.152.0.0/20"),
				),
			},
		},
	})
...
resource "vault_approle_auth_backend_role" "role" {
  ...
  role_id = "%s"
  bind_secret_id = false
  bound_cidr_list = ["10.148.0.0/20", "10.150.0.0/20"]
  policies = ["default", "dev", "prod"]
  secret_id_num_uses = 5
  secret_id_ttl = 600
  token_num_uses = 12
...
resource "vault_approle_auth_backend_role" "role" {
  ...
  role_id = "%s"
  bind_secret_id = true
  bound_cidr_list = ["10.150.0.0/20", "10.152.0.0/20"]
  policies = ["default", "dev"]
  secret_id_num_uses = 10
  secret_id_ttl = 1200
  token_num_uses = 24
