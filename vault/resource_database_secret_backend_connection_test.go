		...
		Steps: []resource.TestStep{
			{
				...
				Check: testComposeCheckFuncCommonDatabaseSecretBackend(name, backend, pluginName,
					...
					resource.TestCheckResourceAttr(testDefaultDatabaseSecretBackendResource, "postgresql.0.max_open_connections", "4"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: testComposeCheckFuncCommonDatabaseSecretBackend(name, backend, pluginName,
					...
					resource.TestCheckResourceAttr(testDefaultDatabaseSecretBackendResource, "mssql.0.max_open_connections", "4"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: testComposeCheckFuncCommonDatabaseSecretBackend(name, backend, dbEngineMySQL.DefaultPluginName(),
					...
					resource.TestCheckResourceAttr(testDefaultDatabaseSecretBackendResource, "mysql.0.max_open_connections", "4"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: testComposeCheckFuncCommonDatabaseSecretBackend(name, backend, dbEngineMySQLRDS.DefaultPluginName(),
					...
					resource.TestCheckResourceAttr(testDefaultDatabaseSecretBackendResource, "mysql_rds.0.max_open_connections", "4"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: testComposeCheckFuncCommonDatabaseSecretBackend(name, backend, dbEngineMySQLAurora.DefaultPluginName(),
					...
					resource.TestCheckResourceAttr(testDefaultDatabaseSecretBackendResource, "mysql_aurora.0.max_open_connections", "4"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: testComposeCheckFuncCommonDatabaseSecretBackend(name, backend, dbEngineMySQLLegacy.DefaultPluginName(),
					...
					resource.TestCheckResourceAttr(testDefaultDatabaseSecretBackendResource, "mysql_legacy.0.max_open_connections", "4"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: testComposeCheckFuncCommonDatabaseSecretBackend(name, backend, pluginName,
					...
					resource.TestCheckResourceAttr(testDefaultDatabaseSecretBackendResource, "redshift.0.max_open_connections", "4"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: testComposeCheckFuncCommonDatabaseSecretBackend(name, backend, pluginName,
					...
					resource.TestCheckResourceAttr(testDefaultDatabaseSecretBackendResource, "hana.0.max_open_connections", "4"),
