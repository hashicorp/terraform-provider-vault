		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// resource.TestCheckResourceAttr(resourceName, "azure.0.name", pathAzure),
					// resource.TestCheckResourceAttr(resourceName, "azure.0.tenant_id", "tenant-test"),
					// resource.TestCheckResourceAttr(resourceName, "azure.0.client_id", "ASIASASNKSADA"),
					// resource.TestCheckResourceAttr(resourceName, "azure.0.client_secret", "8C7THtrIigh2rPZQMbguugt8IUftWhMRCOBzbuyz"),
					// resource.TestCheckResourceAttr(resourceName, "azure.0.vault_name", "vault"),
					// resource.TestCheckResourceAttr(resourceName, "azure.0.key_type", "RSA"),
					// resource.TestCheckResourceAttr(resourceName, "azure.0.key_name", "keyname_test"),
				),
			},
		},
	})
