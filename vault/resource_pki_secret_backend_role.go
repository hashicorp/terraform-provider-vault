	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"backend": {
				...
				Required:    true,
				ForceNew:    true,
				Description: "The path of the PKI secret backend the role belongs to.",
			},
			"name": {
				Type:        schema.TypeString,
				Required:    true,
...
func pkiSecretBackendRoleCreate(d *schema.ResourceData, meta interface{}) error {
	...
	data := map[string]interface{}{
		...
		"max_ttl":                            d.Get("max_ttl").(string),
		"allow_localhost":                    d.Get("allow_localhost").(bool),
		"allow_bare_domains":                 d.Get("allow_bare_domains").(bool),
		"allow_subdomains":                   d.Get("allow_subdomains").(bool),
		"allow_glob_domains":                 d.Get("allow_glob_domains").(bool),
		"allow_any_name":                     d.Get("allow_any_name").(bool),
		"enforce_hostnames":                  d.Get("enforce_hostnames").(bool),
		"allow_ip_sans":                      d.Get("allow_ip_sans").(bool),
		"allowed_uri_sans":                   d.Get("allowed_uri_sans").(string),
		"allowed_other_sans":                 d.Get("allowed_other_sans").(string),
		"server_flag":                        d.Get("server_flag").(bool),
		"client_flag":                        d.Get("client_flag").(bool),
		"code_signing_flag":                  d.Get("code_signing_flag").(bool),
		"email_protection_flag":              d.Get("email_protection_flag").(bool),
		"key_type":                           d.Get("key_type").(string),
		"key_bits":                           d.Get("key_bits").(int),
		"use_csr_common_name":                d.Get("use_csr_common_name").(bool),
		"use_csr_sans":                       d.Get("use_csr_sans").(bool),
		"ou":                                 d.Get("ou").(string),
		...
		"generate_lease":                     d.Get("generate_lease").(bool),
		"no_store":                           d.Get("no_store").(bool),
		"require_cn":                         d.Get("require_cn").(bool),
		"basic_constraints_valid_for_non_ca": d.Get("basic_constraints_valid_for_non_ca").(bool),
	}
