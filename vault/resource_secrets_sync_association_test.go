...
func TestSyncAssociationFieldsFromID(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "mount named 'secret' (edge case - word 'secret' in mount)",
			id:         "gcp-sm/dest/my-dest/mount/secret/secret/mykey",
			wantType:   "gcp-sm",
			wantDest:   "my-dest",
			wantMount:  "secret",
			wantSecret: "mykey",
		...
		{
			name:       "mount containing word 'secret' (edge case)",
			id:         "gcp-sm/dest/my-dest/mount/kv-secret/secret/mykey",
			wantType:   "gcp-sm",
			wantDest:   "my-dest",
			wantMount:  "kv-secret",
			wantSecret: "mykey",
		...
		{
			name:       "secret path with 'secret' directory (edge case)",
