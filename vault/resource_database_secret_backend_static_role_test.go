...
`
	...
	connURLTestRoot := "postgres://postgres:secret@localhost:5432/database?sslmode=disable"
	...
	testutil.GetTestPGUser(t, connURLTestRoot, username, "testpassword", testRoleStaticCreate)
