...
* **New Resources**: `vault_alicloud_secret_backend`, `vault_alicloud_secret_backend_role`, and ephemeral resource `vault_alicloud_access_credentials` for managing AliCloud secrets engine. ([#2809](https://github.com/hashicorp/terraform-provider-vault/pull/2809), [#2824](https://github.com/hashicorp/terraform-provider-vault/pull/2824))
