...
* Add support for new WIF fields in `vault_gcp_secret_backend` ([#2249](https://github.com/hashicorp/terraform-provider-vault/pull/2249)). Requires Vault 1.17+. *Available only for Vault Enterprise*.
* Add support for new WIF fields in `vault_aws_auth_backend_client` ([#2243](https://github.com/hashicorp/terraform-provider-vault/pull/2243)). Requires Vault 1.17+. *Available only for Vault Enterprise*.
