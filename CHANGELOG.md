...
* Add new data source `vault_kv_secret_v2_metadata` to retrieve KV-V2 secret metadata without exposing secret content. ([#2539](https://github.com/hashicorp/terraform-provider-vault/pull/2539)
