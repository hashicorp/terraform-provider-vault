...
* `resource/identtiy_entity_alias`: Add support for `custom_metadata` field in entity aliases. ([#1235](https://github.com/hashicorp/terraform-provider-vault/pull/1235))
