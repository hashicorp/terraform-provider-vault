...
* Add support for new WIF fields in `vault_azure_secret_backend` ([#2250](https://github.com/hashicorp/terraform-provider-vault/pull/2250)). Requires Vault 1.17+. *Available only for Vault Enterprise*.
