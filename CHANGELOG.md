...
* Add support for `use_pss`, `no_store_metadata`, and `serial_number_source` to `vault_pki_secret_backend_role` and add support for `cert_metadata` to `vault_pki_secret_backend_cert` and `vault_pki_secret_backend_sign` [#2420](https://github.com/hashicorp/terraform-provider-vault/pull/2420) 
