...
Add support for ephemeral resource vault_gcp_oauth2_access_token and vault_gcp_service_account_key: ([#2655](https://github.com/hashicorp/terraform-provider-vault/pull/2655))
