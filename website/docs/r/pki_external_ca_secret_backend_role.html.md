...
* `dns_provider_type` - (Optional) The type of the DNS provider. Required when `dns_provider_name` is set. Valid values are `aws-route53`, `rfc2136`, `google-cloud-dns`, `azure-dns`. Requires Vault 2.1.0 or later.
