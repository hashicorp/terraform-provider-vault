...
* `allowed_ipv4_addresses` - (Optional) List of allowed IPv4 addresses for the destination.

* `allowed_ipv6_addresses` - (Optional) List of allowed IPv6 addresses for the destination.

* `allowed_ports` - (Optional) List of allowed ports for the destination.

* `disable_strict_networking` - (Optional) Disable strict networking for the destination.

* `secrets_location` - (Optional) Location where secrets are stored in the destination.

* `environment_name` - (Optional) Environment name for the destination.
