...
// This resource supports "/transform/role".
...
func RoleResource() *schema.Resource {
	...
	return &schema.Resource{
		Read:   roleReadResource,
		Exists: roleResourceExists,
...
func roleReadResource(d *schema.ResourceData, meta interface{}) error {
...
func roleResourceExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	client := meta.(*api.Client)
