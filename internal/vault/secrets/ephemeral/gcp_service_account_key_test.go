		...
		Steps: []resource.TestStep{
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("echo.gcp_key", tfjsonpath.New("data").AtMapKey(consts.FieldLeaseID), knownvalue.StringRegexp(testutil.RegexpNonEmpty)),
					statecheck.ExpectKnownValue("echo.gcp_key", tfjsonpath.New("data").AtMapKey(consts.FieldLeaseDuration), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("echo.gcp_key", tfjsonpath.New("data").AtMapKey("lease_start_time"), knownvalue.StringRegexp(testutil.RegexpNonEmpty)),
